layui.define(['jquery'], function (exports) {
            ...
            containerHTML = '<div id="mtimer" class="mt_poppanel">\
                    <div class="mt_panel">\
                        ...
                        <div class="mt_confirm">\
                            <a href="javascript:void(0);" class="mt-btn-cancel">取消</a>\
                        </div>\
                    </div>\
                </div>';
    ...
    Class.prototype.initDate = function () {
        ...
        for (var i = 0; i < that.config.dateNum; i++) {
            ...
            if (i == 0) {
                dateStr = '<li class="selected" data-date="' + times + '">今天&nbsp;(周' + w + ')</li>';
            } else if (i == 1) {
                dateStr = '<li data-date="' + times + '">明天&nbsp;(周' + w + ')</li>';
            } else {
                dateStr = '<li data-date="' + times + '">' + m + '月' + d + '日&nbsp;(周' + w + ')</li>';
            }
            var liDate = $(dateStr);
